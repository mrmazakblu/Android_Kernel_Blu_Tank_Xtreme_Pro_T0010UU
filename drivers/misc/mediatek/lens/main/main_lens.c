...
static stAF_DrvList g_stAF_DrvList[MAX_NUM_OF_LENS] = {
	...
	{1, AFDRV_GC8024AF, GC8024AF_SetI2Cclient, GC8024AF_Ioctl, GC8024AF_Release},
#endif
#ifdef CONFIG_MTK_LENS_GC5005AF_SUPPORT
	{1, AFDRV_GC5005AF, GC5005AF_SetI2Cclient, GC5005AF_Ioctl, GC5005AF_Release},
#endif
#ifdef CONFIG_MTK_LENS_GC5024AF_SUPPORT
	{1, AFDRV_GC5024AF, GC5024AF_SetI2Cclient, GC5024AF_Ioctl, GC5024AF_Release},
#endif
#ifdef CONFIG_MTK_LENS_HM5040AF_SUPPORT
	{1, AFDRV_HM5040AF, HM5040AF_SetI2Cclient, HM5040AF_Ioctl, HM5040AF_Release},
#endif
#ifdef CONFIG_MTK_LENS_IMX179AF_SUPPORT
	{1, AFDRV_IMX179AF, IMX179AF_SetI2Cclient, IMX179AF_Ioctl, IMX179AF_Release},
#endif
#ifdef CONFIG_MTK_LENS_S5K3H7AF_SUPPORT
	{1, AFDRV_S5K3H7AF, S5K3H7AF_SetI2Cclient, S5K3H7AF_Ioctl, S5K3H7AF_Release},
#endif
#ifdef CONFIG_MTK_LENS_S5K3H7YXAF_SUPPORT
    {1, AFDRV_S5K3H7YXAF, S5K3H7YXAF_SetI2Cclient, S5K3H7YXAF_Ioctl, S5K3H7YXAF_Release},
#endif
#ifdef CONFIG_MTK_LENS_OV8865AF_SUPPORT
	{1, AFDRV_OV8865AF, OV8865AF_SetI2Cclient, OV8865AF_Ioctl, OV8865AF_Release},
#endif
	...
	{1, AFDRV_SP5506AF, SP5506AF_SetI2Cclient, SP5506AF_Ioctl, SP5506AF_Release},
#endif
#ifdef CONFIG_MTK_LENS_IMX237AF_SUPPORT
	{1, AFDRV_IMX237AF, IMX237AF_SetI2Cclient, IMX237AF_Ioctl, IMX237AF_Release},
#endif
#ifdef CONFIG_MTK_LENS_MN34172AF_SUPPORT
	{1, AFDRV_MN34172AF, MN34172AF_SetI2Cclient, MN34172AF_Ioctl, MN34172AF_Release},
#endif
#ifdef CONFIG_MTK_LENS_MN045AF_SUPPORT
	{1, AFDRV_MN045AF, MN045AF_SetI2Cclient, MN045AF_Ioctl, MN045AF_Release},
#endif
#ifdef CONFIG_MTK_LENS_S5K3L2AF_SUPPORT
	{1, AFDRV_S5K3L2AF, S5K3L2AF_SetI2Cclient, S5K3L2AF_Ioctl, S5K3L2AF_Release},
#endif
#ifdef CONFIG_MTK_LENS_IMX214AF_SUPPORT
{1, AFDRV_IMX214AF, IMX214AF_SetI2Cclient, IMX214AF_Ioctl, IMX214AF_Release},
#endif
#ifdef CONFIG_MTK_LENS_IMX219AF_SUPPORT
{1, AFDRV_IMX219AF, IMX219AF_SetI2Cclient, IMX219AF_Ioctl, IMX219AF_Release},
#endif
#ifdef CONFIG_MTK_LENS_SP8407AF_SUPPORT
{1, AFDRV_SP8407AF, SP8407AF_SetI2Cclient, SP8407AF_Ioctl, SP8407AF_Release},
#endif
#ifdef CONFIG_MTK_LENS_OV8858AF_SUPPORT
	{1, AFDRV_OV8858AF, OV8858AF_SetI2Cclient, OV8858AF_Ioctl, OV8858AF_Release},
#endif
#ifdef CONFIG_MTK_LENS_HI545AF_SUPPORT
	{1, AFDRV_HI545AF, HI545AF_SetI2Cclient, HI545AF_Ioctl, HI545AF_Release},
#endif
#ifdef CONFIG_MTK_LENS_IMX149AF_SUPPORT
	{1, AFDRV_IMX149AF, IMX149AF_SetI2Cclient, IMX149AF_Ioctl,IMX149AF_Release},
#endif
#ifdef CONFIG_MTK_LENS_S5K3L8AF_SUPPORT
    {1, AFDRV_S5K3L8AF, S5K3L8AF_SetI2Cclient, S5K3L8AF_Ioctl, S5K3L8AF_Release},
#endif
#ifdef CONFIG_MTK_LENS_OV5693AF_SUPPORT
    {1, AFDRV_OV5693AF, OV5693AF_SetI2Cclient, OV5693AF_Ioctl, OV5693AF_Release},
#endif
};
