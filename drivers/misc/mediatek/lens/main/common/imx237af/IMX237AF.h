...
#define IMX237AFIOC_G_MOTORINFO _IOR(IMX237AF_MAGIC, 0, stIMX237AF_MotorInfo)

#define IMX237AFIOC_T_MOVETO _IOW(IMX237AF_MAGIC, 1, u32)

#define IMX237AFIOC_T_SETINFPOS _IOW(IMX237AF_MAGIC, 2, u32)

#define IMX237AFIOC_T_SETMACROPOS _IOW(IMX237AF_MAGIC, 3, u32)
#ifdef LensdrvCM3
#define IMX237AFIOC_G_MOTORMETAINFO _IOR(IMX237AF_MAGIC, 4, stIMX237AF_MotorMETAInfo)
#endif
