...
#if defined(DROI_PRO_FQ5C)||defined(DROI_PRO_FQ5CW)||defined(DROI_PRO_PU6)
#if defined(CONFIG_MTK_PUMP_EXPRESS_PLUS_SUPPORT)
#else
static int ncp_reset_index=0;
#endif
#endif
...
#if defined(DROI_PRO_FQ5C)||defined(DROI_PRO_FQ5CW)||defined(DROI_PRO_PU6)
	ncp1854_set_ieoc(0x0); /* cut off current = 100mA */ //4:200 3:175 2:150   step:25mA
#else
	ncp1854_set_ieoc(0x2); /* cut off current = 150mA */ //4:200 3:175 2:150
#endif
...
#if defined(QUICK_CHARGER_5V2A_SUPPORT)||defined(CONFIG_MTK_PUMP_EXPRESS_PLUS_SUPPORT)
	unsigned int set_chr_current;
	unsigned int array_size;
	unsigned int register_value;
	unsigned int current_value = *(unsigned int *) data;
...
#else
	ncp1854_set_iinlim(0x3);  //limit input current 1.5A
	ncp1854_set_iinlim_ta(0x0);
#endif
