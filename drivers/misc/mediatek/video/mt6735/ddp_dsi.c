				    ...
				    LCM_DSI_PARAMS *dsi_params)
{
	...
	bool hstx_cklp_en = true;//Harvey 180104 false
...
int ddp_dsi_build_cmdq(DISP_MODULE_ENUM module, void *cmdq_trigger_handle, CMDQ_STATE state)
{
	...
	if (state == CMDQ_BEFORE_STREAM_SOF) {
		...
		for (i = 0; i < 3; i++) {
			...
			t0.Data_ID =(t0.Data0 <0xff) ? DSI_DCS_READ_PACKET_ID :DSI_GERNERIC_READ_LONG_PACKET_ID;//Harvey modify B0 to 00
			t0.Data1 = 0;
			t1.CONFG = 0x00;
...
//harvey 180104 begin
	switch(recv_data_cnt)
   	...
   	//		printk("tuwz 3 byte");
				...
				ret = 0; // esd pass
				printk("harvey func==%s line=%d ret1=%d\n", __func__, __LINE__, ret);
				}
				else
				{
				printk("esd_check1: %#x, %#x, %#x, %#x, %#x, %#x \n", read_data1.byte0, dsi_params->lcm_esd_check_table[i].para_list[0], read_data1.byte1,dsi_params->lcm_esd_check_table[i].para_list[1]
					, read_data1.byte2,dsi_params->lcm_esd_check_table[i].para_list[2]);
				ret = 1; // esd fail
				printk("harvey func==%s line=%d ret2=%d esd fail \n", __func__, __LINE__, ret);
   	...
   	//		printk("tuwz 3 byte");
				...
				ret = 0; // esd pass
				printk("harvey func==%s line=%d ret3=%d\n", __func__, __LINE__, ret);
				}
				else
				{
				printk("esd_check1: %#x, %#x, %#x, %#x, %#x, %#x \n", read_data1.byte0, dsi_params->lcm_esd_check_table[i].para_list[0], read_data1.byte1,dsi_params->lcm_esd_check_table[i].para_list[1]
					, read_data1.byte2,dsi_params->lcm_esd_check_table[i].para_list[2]);
				ret = 1; // esd fail
				printk("harvey func==%s line=%d ret4=%d esd fail \n", __func__, __LINE__, ret);
				goto lable;
				}
				break;
		case 3:
   	...
   	//		printk("tuwz 3 byte");
					...
					ret = 0; // esd pass
					printk("harvey func==%s line=%d ret5=%d\n", __func__, __LINE__, ret);
				}
				else
				{
				printk("esd_check1: %#x, %#x, %#x, %#x, %#x, %#x \n", read_data1.byte0, dsi_params->lcm_esd_check_table[i].para_list[0], read_data1.byte1,dsi_params->lcm_esd_check_table[i].para_list[1]
					, read_data1.byte2,dsi_params->lcm_esd_check_table[i].para_list[2]);
				ret = 1; // esd fail
				printk("harvey func==%s line=%d ret6=%d esd fail\n", __func__, __LINE__, ret);
				goto lable;
				}
				break;
		case 5:
				...
				&& (read_data2.byte0 == dsi_params->lcm_esd_check_table[i].para_list[4]))
				{
   	//		printk("tuwz 3 byte");
					printk("esd_check: %#x, %#x, %#x, %#x, %#x, %#x, %#x, %#x, %#x, %#x \n", read_data1.byte0, dsi_params->lcm_esd_check_table[i].para_list[0], read_data1.byte1, dsi_params->lcm_esd_check_table[i].para_list[1]
					, read_data1.byte2, dsi_params->lcm_esd_check_table[i].para_list[2], read_data1.byte3, dsi_params->lcm_esd_check_table[i].para_list[3], read_data2.byte0, dsi_params->lcm_esd_check_table[i].para_list[4]);

					ret = 0; // esd pass
					printk("harvey func==%s line=%d ret7=%d\n", __func__, __LINE__, ret);
				}
				else
				{
				printk("esd_check: %#x, %#x, %#x, %#x, %#x, %#x, %#x, %#x, %#x, %#x \n", read_data1.byte0, dsi_params->lcm_esd_check_table[i].para_list[0], read_data1.byte1, dsi_params->lcm_esd_check_table[i].para_list[1]
					, read_data1.byte2, dsi_params->lcm_esd_check_table[i].para_list[2], read_data1.byte3, dsi_params->lcm_esd_check_table[i].para_list[3], read_data2.byte0, dsi_params->lcm_esd_check_table[i].para_list[4]);
				ret = 1; // esd fail
				printk("harvey func==%s line=%d ret8=%d esd fail\n", __func__, __LINE__, ret);
				goto lable;
				}
				break;
//harvey 180104 begin
...
//harvey 180104 end
		...
		//printk("harvey func==%s line=%d other type\n", __func__, __LINE__);
		recv_data_cnt = 2;
		if(recv_data_cnt > (dsi_params->lcm_esd_check_table[i].count))
		{
	...
	//		printk("tuwz 1 byte");
			...
			{
				ret = 1; // esd fail
				//printk("harvey func==%s line=%d ret8=%d\n", __func__, __LINE__, ret);
				break;
			}
		}
		}
		...
		/* create 3 slot */
//harvey 180104 begin
		cmdqBackupAllocateSlot(&hSlot[0], 3);//4
