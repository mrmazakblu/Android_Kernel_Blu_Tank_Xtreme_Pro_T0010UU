...
#if defined(DROI_PRO_FQ5C)||defined(DROI_PRO_Q1)||defined(DROI_PRO_FQ5B)||defined(DROI_PRO_K8)||defined(DROI_PRO_PF5T)||defined(DROI_PRO_PU6T)||defined(DROI_PRO_F5CT)
#ifdef CONFIG_OF
/* device tree */
#include <linux/of.h>
...
#if defined(DROI_PRO_FQ5C)||defined(DROI_PRO_Q1)||defined(DROI_PRO_FQ5B)||defined(DROI_PRO_K8)||defined(DROI_PRO_PF5T)||defined(DROI_PRO_PU6T)||defined(DROI_PRO_F2C)||defined(DROI_PRO_F5CT)
...
#if defined(DROI_PRO_FQ5C)||defined(DROI_PRO_Q1)||defined(DROI_PRO_FQ5B)||defined(DROI_PRO_K8)||defined(DROI_PRO_PF5T)||defined(DROI_PRO_PU6T)||defined(DROI_PRO_F5CT)
#ifdef CONFIG_OF
static const struct of_device_id FLASHLIGHT_HW_of_ids[] = {
...
#if defined(DROI_PRO_FQ5C)||defined(DROI_PRO_Q1)||defined(DROI_PRO_FQ5B)||defined(DROI_PRO_K8)||defined(DROI_PRO_PF5T)||defined(DROI_PRO_PU6T)||defined(DROI_PRO_F5CT)
#ifdef CONFIG_OF
		   .of_match_table = FLASHLIGHT_HW_of_ids,
#endif
#endif
		   },
};
