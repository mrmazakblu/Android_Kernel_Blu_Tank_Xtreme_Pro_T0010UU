...
#define SENSOR_TYPE_DROI_GESTURE		(46)
#define SENSOR_STRING_TYPE_DROI_GESTURE				"android.sensor.droi_gesture"
...
#define ID_DROI_GESTURE				(SENSOR_TYPE_DROI_GESTURE - 1)
#define ID_SENSOR_MAX_HANDLE	  (ID_BASE+SENSOR_TYPE_DROI_GESTURE)
...
#define SENSOR_DROI_GESTURE				(1 << ID_DROI_GESTURE)
