...
#if defined(TYD_PRO_WF5_GB)||defined(DROI_PRO_WF6_GB)||defined(DROI_PRO_FQ5CW_XWP)||defined(DROI_PRO_FQ5CW_NJX)
	#define CUST_IMAGE_H_MIRROR
#endif
#if defined(DROI_PRO_WQ1)
extern bool mipi_switch_enable;
#endif
...
#ifdef CUST_IMAGE_H_MIRROR
    .checksum_value = 0xe7010805,        //checksum value for Camera Auto Test
#else
...
{
	LOG_INF("E new init by wenwu.xu");
   ...
   write_cmos_sensor(0x17, 0x15);//16
	...
	write_cmos_sensor(0x1f,0xc9);//c8 //08//rsgl_s_mode/vpix_s_mode \A6\CC?1\A8\B9o\A8\A2\A8\AC???
	...
	write_cmos_sensor(0x27,0x20); //\A6\CC?1\A8\B9o\A8\A2\A8\AC???
...
static kal_uint32 capture(MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *image_window,
                          MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
    LOG_INF("capture function gc2755 Enter\n");
