...
//none
#else
	#define CHANGE_IMX179_IMAGE_IMAGE_NORMAL
	#define IMX179_SENSOR_OUTPUT_FORMAT_RAW_B
#endif

static UINT8 OtpEn = 0;

static imgsensor_info_struct imgsensor_info = { 
	.sensor_id = IMX179_SENSOR_ID,
	
	.checksum_value = 0x8d9f4a5f,//0x9e08861f,
...
#if defined(IMX179_SENSOR_OUTPUT_FORMAT_RAW_B)
	.sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW_B,
#else
	.sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW_R,
#endif
	.mclk = 24,
#if defined(TYD_PRO_W2_YS)||defined(TYD_PRO_W2_YS2)
	.mipi_lane_num = SENSOR_MIPI_2_LANE,
#else
	.mipi_lane_num = SENSOR_MIPI_4_LANE,
#endif
	.i2c_addr_table = {0x34,0x20,0x60,0x3c,0xff},
...
{
int sensorid;
	sensorid =  ((read_cmos_sensor(0x0000)&&0x0f)<<8)  | (read_cmos_sensor(0x0001));
	LOG_INF("liyeqiang2read sensor id:%x", sensorid);
...
static kal_uint16 set_gain(kal_uint16 gain)
{
	...
	if(reg_gain > 0xe0)
    	reg_gain = 0xe0;
  write_cmos_sensor(0x0104, 0x01);
  write_cmos_sensor(0x205, (kal_uint8)reg_gain);
...
#if defined(TYD_PRO_W2_YS)||defined(TYD_PRO_W2_YS2)
	write_cmos_sensor(0x0114, 0x01);//W2_YS imx179 not on
#endif
	write_cmos_sensor(0x0104, 0x01);//group
	write_cmos_sensor(0x0100, 0x00);//STREAM OFF 
	
#if defined(CHANGE_IMX179_IMAGE_IMAGE_NORMAL)
...
#if defined(TYD_PRO_W2_YS)||defined(TYD_PRO_W2_YS2)
	write_cmos_sensor(0x3364, 0x02); //0x00	
#else		 
