...
#include "s5k3h2mipiraw_Sensor.h"
...
static imgsensor_info_struct imgsensor_info = {
	...
	.pre = {
		...
		.starty = 3,					//record different mode's starty of grabwindow
		...
		.mipi_data_lp2hs_settle_dc = 23//unit , ns 120 85 60 40 30 20
...
void S5K3H2YXMIPI_set_8M_FullSize(void)
{
	   ...
	   //?3Mode Setting 	   Readout Full 	   15  fps
	   write_cmos_sensor_8(0x0100,0x00); // stream off
	 //  write_cmos_sensor_8(0x0103,0x01); // software reset
		mdelay(20);
	   ...
	   write_cmos_sensor_8(0x030B, 0x01);   //op_sys_clk_div = 1
	   write_cmos_sensor_8(0x0309, 0x05);   //op_pix_clk_div = 5
	   write_cmos_sensor_8(0x30CC, 0xB0);   //DPHY_band_ctrl 640\A1\AB690MHz
	   write_cmos_sensor_8(0x31A1, 0x58);   //EMI control
