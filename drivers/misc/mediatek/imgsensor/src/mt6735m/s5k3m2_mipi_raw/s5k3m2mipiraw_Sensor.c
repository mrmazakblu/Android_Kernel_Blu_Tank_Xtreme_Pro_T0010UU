...
#include "s5k3m2mipiraw_Sensor.h"
...
{
	 printk("dummyline = %d, dummypixels = %d ", imgsensor.dummy_line, imgsensor.dummy_pixel);
...
static void sensor_init(void)
{
  ...
  if (chip_id == 0xC001) {
  printk("-- sensor_init, chip id = 0xC001\n");
  //e 2014/12/01, bruce
	printk("E\n");  
...
//	otp_lsc_update();
  ...
  //s 2014/12/01, bruce
    ...
    printk("-- sensor_init, chip id = 0xD101\n");
  write_cmos_sensor(0x6028, 0x4000);
  write_cmos_sensor(0x6214, 0x7971);
  write_cmos_sensor(0x6218, 0x0100);
  //SW page
...
//  write_cmos_sensor(0x3AFA, 0xFBB8);   //eliminated
  ...
  write_cmos_sensor(0x6F12, 0x99BF);
    ...
    printk("-- sensor_init, Read back other chip id = 0x%x\n", chip_id);
  }
  //e 2014/12/01, bruce
}	/*	sensor_init  */
/**********************************************************************************************************************/
...
static void preview_setting(void)
{
	...
	if (chip_id == 0xC001) {
		printk("--preview_setting chip_id = 0xC001\n");
        // e 2014/12/01, bruce
	printk("hesong 3 Preview E! ");
	//p200
...
// s 2014/12/01, bruce
	...
	printk("--preview_setting, chip_id = 0xD101\n");
...
write_cmos_sensor_8(0x0100,0x01);
	...
	printk("--preview_setting, chip_id = 0x0%x\n", chip_id);
}
// e 2014/12/01, bruce
}	/*	preview_setting  */
/**********************************************************************************************************************/
...
static void normal_capture_setting(void)
{
	...
	kal_uint16 chip_id = 0;
		chip_id = read_cmos_sensor(0x0002);
	if (chip_id == 0xC001) {
	printk("-- normal_capture_settings, chip id = 0xC001\n");
	// e bruce, 2014/12/01
	printk("hesong 3 Normal capture E! ");
...
// s bruce, 2014/12/01
	...
	printk( "-- normal_capture_setting, chip_id = 0xD101\n");
write_cmos_sensor_8(0x0100,0x00);
mdelay(200);
write_cmos_sensor(0x6028,0x2000);
write_cmos_sensor(0x602A,0x14F0);
...
write_cmos_sensor_8(0x0100,0x01);
	...
	printk( "-- normal_capture_setting, chip_id = 0x%x\n", chip_id);
}
// e bruce, 2014/12/01	
}
...
static void pip_capture_setting(void)
{
	...
	chip_id = read_cmos_sensor(0x0002);
	if (chip_id == 0xC001) {
	printk( "--pip_capture_setting, chip_id = 0xC001\n");
	// e bruce, 2014/12/01
	printk( "S5K3M2 PIP setting Enter!"); 
	write_cmos_sensor(0x6028,0x4000);
	write_cmos_sensor(0x32CA,0x022B);
	write_cmos_sensor(0x32D6,0x022B);
	write_cmos_sensor(0x0344,0x0010);//bpc off, no matter mirrir flip, PV & cap FOV the same
...
{
	printk( "--pip_capture_setting, chip_id = 0x%x\n", chip_id);	
	write_cmos_sensor_8(0x0100,0x00);
	mdelay(200);
	write_cmos_sensor(0x6028,0x2000);
	write_cmos_sensor(0x602A,0x14F0);
...
static void hs_video_setting(void)
{
	...
	chip_id = read_cmos_sensor(0x0002);
	if (chip_id == 0xC001) {
		printk("--hs_video_setting. chip_id = 0xC001\n");
	// e bruce, 2014/12/01
	printk("E");
//p200
...
// s bruce 2014/12/01
	...
	printk("--hs_video_setting. chip_id = 0xD101\n");
write_cmos_sensor_8(0x0100,0x00);
mdelay(200);
	write_cmos_sensor(0x6028,0x2000);
	write_cmos_sensor(0x602A,0x14F0);
	...
	printk("--hs_video_setting. chip_id = 0x%x\n", chip_id);
}
// e bruce 2014/12/01
}
...
static void slim_video_setting(void)
{
	...
	chip_id = read_cmos_sensor(0x0002);
	if (chip_id == 0xC001) {
		printk("--slim_video_setting. chip_id = 0xC001\n");
	// e bruce, 2014/12/01
	printk("E");
	write_cmos_sensor(0x6028,0x4000);
	write_cmos_sensor(0x32CA,0x022B);
...
//s bruce, 2014/12/01
	...
	printk("--slim_video_setting. chip_id = 0xD101");
	write_cmos_sensor_8(0x0100,0x00);
  mdelay(200);
	write_cmos_sensor(0x6028,0x2000);
	write_cmos_sensor(0x602A,0x14F0);
	...
	write_cmos_sensor_8(0x0100,0x01);		
		...
		printk("--slim_video_setting. chip_id = 0x%x\n", chip_id);
	}
//e bruce, 2014/12/01
}
