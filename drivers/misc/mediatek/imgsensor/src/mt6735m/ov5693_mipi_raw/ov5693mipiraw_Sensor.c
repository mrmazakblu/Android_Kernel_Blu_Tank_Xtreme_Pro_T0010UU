...
#define LOG_1 printk("OV5693,MIPI 2LANE\n")
...
static imgsensor_info_struct imgsensor_info = {
    ...
    .cap_delay_frame = 1,        //enter capture delay frame num 3
    .pre_delay_frame = 2,         //enter preview delay frame num  3
    .video_delay_frame = 1,        //enter video delay frame num   3
    .hs_video_delay_frame = 2,    //enter high speed video  delay frame num  3
    .slim_video_delay_frame = 2,//enter slim video delay frame num   3
...
static void sensor_init(void)
{
    ...
    */
    ...
    /********************************************************
       ...
       *
       ********************************************************/
    write_cmos_sensor(0x3820,0x01);  //v fast bin on, v flip off, v bin off           //04    00
    write_cmos_sensor(0x3821,0x1b);  //hsync on, mirror on, hbin on              //1f    1e
...
static void preview_setting(void)
{
    ...
    /********************************************************
       ...
       *
       ********************************************************/
    write_cmos_sensor(0x3820,0x01);  //v fast bin on, v flip off, v bin off
