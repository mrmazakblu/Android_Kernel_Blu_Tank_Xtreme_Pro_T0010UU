...
static void GC2155MIPI_Sensor_Init(void)
{
	...
	GC2155MIPI_write_cmos_sensor(0x1f , 0x2d);
	GC2155MIPI_write_cmos_sensor(0x20 , 0x3d);
	...
	GC2155MIPI_write_cmos_sensor(0x97 , 0x65);
	GC2155MIPI_write_cmos_sensor(0x98 , 0x88);
	GC2155MIPI_write_cmos_sensor(0x9d , 0x06);
	...
	GC2155MIPI_write_cmos_sensor(0x82 , 0x06);
	...
	///////////////////////////////////////////////
	GC2155MIPI_write_cmos_sensor(0xfe , 0x02);
	GC2155MIPI_write_cmos_sensor(0xd1 , 0x22);
	GC2155MIPI_write_cmos_sensor(0xd2 , 0x2a);
	GC2155MIPI_write_cmos_sensor(0xd3 , 0x44);
	GC2155MIPI_write_cmos_sensor(0xd5 , 0xf8);
	...
	GC2155MIPI_write_cmos_sensor(0x29 , 0x07);
	GC2155MIPI_write_cmos_sensor(0x2a , 0xd0); //14fps
	GC2155MIPI_write_cmos_sensor(0x2b , 0x09);
	GC2155MIPI_write_cmos_sensor(0x2c , 0xc4); //12fps
...
BOOL GC2155MIPI_set_param_exposure(UINT16 para)
{
	switch (para)
	{
		...
		case AE_EV_COMP_10:
			GC2155MIPI_SET_PAGE1;
			GC2155MIPI_write_cmos_sensor(0x13,0x60);
			GC2155MIPI_SET_PAGE0;
		break;
		case AE_EV_COMP_13:
			GC2155MIPI_SET_PAGE1;
			GC2155MIPI_write_cmos_sensor(0x13,0x70);
			GC2155MIPI_SET_PAGE0;
		break;
		default:
		return FALSE;
