...
#include "imx219submipiraw_Sensor.h"

/****************************Modify following Strings for debug****************************/
#define PFX "imx219sub_camera_sensor"
#define LOG_1 LOG_INF("imx219sub,MIPI 2LANE\n")
...
#if 1//defined(DROI_PRO_U9Y)
#define IMX219_MIPI_2LANE 1
#else
#define IMX219_MIPI_2LANE 0
#endif

static imgsensor_info_struct imgsensor_info = {
	.sensor_id = IMX219SUB_SENSOR_ID,		//record sensor id defined in Kd_imgsensor.h

	.checksum_value = 0x9e08861c,		//checksum value for Camera Auto Test

	.pre = {
		#if IMX219_MIPI_2LANE
		...
		#if IMX219_MIPI_2LANE
		.mipi_data_lp2hs_settle_dc = 32,//unit , ns
		#else
...
#define IMX219SUBMIPI_MaxGainIndex (97)
kal_uint16 IMX219SUBMIPI_sensorGainMapping[IMX219SUBMIPI_MaxGainIndex][2] ={
{ 64 ,0  },
{ 68 ,12 },
{ 71 ,23 },
{ 74 ,33 },
...
{
	kal_uint8 iI;
    LOG_INF("[IMX219SUBMIPI]enter IMX219SUBMIPIGain2Reg function\n");
    for (iI = 0; iI < (IMX219SUBMIPI_MaxGainIndex-1); iI++)
	{

        if(gain <IMX219SUBMIPI_sensorGainMapping[iI][0])
		{
            break;
        }
		if(gain < IMX219SUBMIPI_sensorGainMapping[iI][0])
		{
			return IMX219SUBMIPI_sensorGainMapping[iI][1];
		}
    ...
    if(gain != IMX219SUBMIPI_sensorGainMapping[iI][0])
    {
         LOG_INF("Gain mapping don't correctly:%d %d \n", gain, IMX219SUBMIPI_sensorGainMapping[iI][0]);
    }
	LOG_INF("exit IMX219SUBMIPIGain2Reg function\n");
    return IMX219SUBMIPI_sensorGainMapping[iI-1][1];
	//return NONE;
...
//
kal_uint8  test_pattern_flag_sub=0;
