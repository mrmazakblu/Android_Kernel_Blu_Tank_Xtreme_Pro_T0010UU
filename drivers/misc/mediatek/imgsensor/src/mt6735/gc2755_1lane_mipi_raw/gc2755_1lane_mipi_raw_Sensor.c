...
#include "gc2755_1lane_mipi_raw_Sensor.h"

//#define GC2755MIPI_2LANE

/****************************Modify Following Strings for Debug****************************/
#define PFX "GC2755_MPI_1LANE_RAW_camera_sensor"
#define LOG_1 LOG_INF("GC2755,MIPI 1LANE\n")
...
kal_bool GC2755DuringTestPattern1Lane = KAL_FALSE;

static imgsensor_info_struct imgsensor_info = {
    .sensor_id = GC2755_1LANE_SENSOR_ID,        //record sensor id defined in Kd_imgsensor.h
...
{
    return ((read_cmos_sensor(0xf0) << 8) | read_cmos_sensor(0xf1)) + 0x100;
}
...
static kal_uint32 open(void)
{
    ...
    spin_unlock(&imgsensor_drv_lock);
    GC2755DuringTestPattern1Lane = KAL_FALSE;
