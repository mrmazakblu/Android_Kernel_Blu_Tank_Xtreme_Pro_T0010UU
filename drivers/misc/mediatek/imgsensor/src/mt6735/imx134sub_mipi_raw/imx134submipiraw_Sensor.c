...
#include "imx134submipiraw_Sensor.h"
...
static imgsensor_info_struct imgsensor_info = {
	.sensor_id = IMX134SUB_SENSOR_ID,		//record sensor id defined in Kd_imgsensor.h
...
#define IMX134SUBMIPI_MaxGainIndex (97)
kal_uint16 IMX134SUBMIPI_sensorGainMapping[IMX134SUBMIPI_MaxGainIndex][2] ={
{ 64 ,0  },
{ 68 ,12 },
{ 71 ,23 },
{ 74 ,33 },
...
static kal_uint32 return_sensor_id(void)
{
	...
	return (((read_cmos_sensor(0x0016)&&0x0f)<<8) | read_cmos_sensor(0x0017))-1;
	/*
	int sensorid;
...
{
    kal_uint8 iI;
    for (iI = 0; iI < (IMX134SUBMIPI_MaxGainIndex-1); iI++)
    {
        if(gain <= IMX134SUBMIPI_sensorGainMapping[iI][0])
        {
            break;
        }
    }
     ...
     */
    return IMX134SUBMIPI_sensorGainMapping[iI][1];
