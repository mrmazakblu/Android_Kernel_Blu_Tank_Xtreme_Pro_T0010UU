...
//SUB DVDD MAX 1.5V
		...
		{SENSOR_DRVNAME_IMX219SUB_MIPI_RAW,
			{
				{SensorMCLK,Vol_High, 0},
				{VCAMIO, Vol_1800, 10},
				{VCAMA,  Vol_2800, 10},
		...
		{SENSOR_DRVNAME_IMX134SUB_MIPI_RAW,
			{
				{VCAMA,  Vol_2800, 10},
				{VCAMD,  Vol_1200, 10},
				{VCAMIO, Vol_1800, 10},
...
//Modify camera main2 by Droi DXQ start 20170906
	...
	if (currSensorName && (strcmp(currSensorName, "imx219submipiraw") == 0)) {
		if ((pinSetIdx == 0)||(pinSetIdx == 2))
			goto _kdCISModulePowerOn_exit_;
	}
	if (currSensorName && (strcmp(currSensorName, "imx219mipiraw") == 0)) {
	...
	if (currSensorName && (strcmp(currSensorName, "imx134submipiraw") == 0)) {
		if ((pinSetIdx == 0)||(pinSetIdx == 2))
			goto _kdCISModulePowerOn_exit_;
	}
	if (currSensorName && (strcmp(currSensorName, "imx134mipiraw") == 0)) {
		if ((pinSetIdx == 1)||(pinSetIdx == 2))
			goto _kdCISModulePowerOn_exit_;
	}
#endif
...
//Modify camera main2 by Droi DXQ end 20170906
	...
	if (On)
	{
		...
		for(pwListIdx=0 ; pwListIdx<21; pwListIdx++)
		{
		...
		for(pwListIdx=0 ; pwListIdx<22; pwListIdx++)
		{
			if(currSensorName && (PowerOnList.PowerSeq[pwListIdx].SensorName!=NULL) && (0 == strcmp(PowerOnList.PowerSeq[pwListIdx].SensorName,currSensorName)))
			{
				PK_DBG("kdCISModulePowerOn get in--- \n");
