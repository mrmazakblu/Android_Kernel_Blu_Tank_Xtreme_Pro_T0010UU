...
/*FWVGA*/
#if defined(ST7701_DSI_6735_FWVGA)
	&st7701_dsi_6735_fwvga_drv,
#endif
/* HD */
#if defined(RM68191_DSI_6735_QHD)
	&rm68191_dsi_6735_qhd_lcm_drv,
#endif
#if defined(ILI9881_DSI_6735_HD)
	&ili9881_dsi_6735_hd_drv,
#endif
#if defined(NT35521_DSI_6735_HD)
	&nt35521_dsi_6735_hd_drv,
#endif
#if defined(HX8394A_DSI_6735_HD)
	&hx8394a_dsi_6735_hd_drv,
#endif
#if defined(HX8394D_DSI_6735_HD)
	&hx8394d_dsi_6735_hd_drv,
#endif
#if defined(OTM1285_DSI_6735_HD)
	&otm1285_dsi_6735_hd_drv,
#endif
#if defined(OTM1287A_DSI_6580_HD)
	&otm1287a_dsi_6580_hd_drv,
#endif

#if defined(OTM1287A_DSI_6735_HD)
	&otm1287a_dsi_6735_hd_drv,
#endif

#if defined(OTM1289A_DSI_6735_HD)
	&otm1289a_dsi_6735_hd_drv,
#endif

#if defined(OTM1285A_HD720_DSI_VDO)
	&otm1285a_hd720_dsi_vdo_drv,
#endif

#if defined(JD9369_DSI_6735_HD)
	&jd9369_dsi_6735_hd_drv,
#endif

#if defined(JD9365_DSI_6735_HD)
	&jd9365_dsi_6735_hd_drv,
#endif



#if defined(FL11281_DSI_6735_HD)
	&fl11281_hd720_dsi_vdo_drv,
#endif
#if defined(RM68200_DSI_6735_HD)
	&rm68200_dsi_6735_hd_drv,
#endif
#if defined(NT35532_DSI_6735_FHD)
		&nt35532_dsi_6735_fhd_lcm_drv,
#endif
#if defined(S6D7AA0_HD_VDO)
		&s6d7aa0_hd_vdo_drv,
#endif
#if defined(NT35523_DSI_6735_HD)
	&nt35523_dsi_6735_hd_drv,
#endif
#if defined(NT35521_DSI_6735_HD_TPS65132)
	&nt35521_dsi_6735_hd_tps65132_drv,
#endif
#if defined(RM67200_DSI_6735_HD)
	&rm67200_dsi_6735_hd_drv,
#endif
#if defined(ST7703_DSI_6735_HD)
	&st7703_hd720_dsi_vdo_drv,
#endif
#if defined(ST7703_DSI_6735_HDPLUS)
	&st7703_hdplus_dsi_vdo_drv,
#endif
#if defined(OTM1191A_DSI_6735_FHD)
	&otm1191a_dsi_6735_fhd_lcm_drv,
#endif
#if defined(NT35596_DSI_6735_FHD)
