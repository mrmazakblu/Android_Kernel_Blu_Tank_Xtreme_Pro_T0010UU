#ifndef __LCD_NT35523_DSI_6735_HD_FQ5B_H__
#define __LCD_NT35523_DSI_6735_HD_FQ5B_H__

#if defined(DROI_PRO_FQ5B_FAC)
...
static struct LCM_setting_table lcm_initialization_setting[] = {
	{0xF0, 5, {0x55 ,0xAA ,0x52 ,0x08 ,0x01 }}, //////////page 1    Fo{0x 2 POWE{0x to 3 powe{0x IC  NT50198B cont{0xol
	{0xC0, 1, {0x01 }},                 ////////////////               Fo{0x 2 POWE{0x to 3 powe{0x IC  NT50198B cont{0xol
	...
	{0xBC, 2, {0x50 ,0x00 }},  
	{0xBD, 2, {0x50 ,0x00 }},  
	{0xBE, 2, {0x00 ,0x71 }}, //        BE¼Ä´æÆ÷ÊÇVCOMÉèÖÃ£¬ÐèÃ¿Æ¬¶¼µ÷Õû
	{0xBF, 2, {0x00 ,0x71 }}, //         ½¨ÒéBF¼Ä´æÆ÷ÉèÖÃµÈÓÚBE¼Ä´æÆ÷
	...
	{0xB3, 4, {0x83 ,0x23 ,0x42 ,0x97 }},/// B3¼Ä´æÆ÷µÄµÚ3ºÍµÚ4¸ö²ÎÊýº¬ÓÐVCOMDCOFF[8:0]ÉèÖÃ£¬ÊÇsleep in Ê±VCOM´óÐ¡£¬Æä¶ÔÓ¦µçÑ¹´óÐ¡Ó¦ÎªBE´¦ÉèÖÃµÄVCOMµçÑ¹µÄÖµµÄ´óÐ¡µÄÒ»°ë£¬ÐèÃ¿Æ¬¶¼µ÷Õû
...
#endif /*__LCD_NT35523_DSI_6735_HD_FQ5B_H__*/
