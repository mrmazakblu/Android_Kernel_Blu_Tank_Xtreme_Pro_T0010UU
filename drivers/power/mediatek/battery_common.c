...
static char high_volt_support[20] = "v";
static char bat_cap[20] = "v";
static hw_module_info hw_info = {
	.type = HW_MODULE_TYPE_BATTERY,
	.id = 2000,
	.priority = HW_MODULE_PRIORITY_BATTERY,
	.name = "Li-ion",
	.vendor = high_volt_support,
	.more = bat_cap
};
...
#if defined(CONFIG_MTK_LED_CHR_SUPPORT)
