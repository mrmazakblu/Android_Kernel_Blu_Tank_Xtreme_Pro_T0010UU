...
#define TPD_KEYS_DIM            		{{80,1320,20,TPD_BUTTON_HEIGH}, {360,1320,20,TPD_BUTTON_HEIGH}, {240,1320,20,TPD_BUTTON_HEIGH}}
#else
...
//#define TPD_AUTO_UPGRADE
#endif
#if defined(DROI_PRO_FQ5C_XDNZ)||defined(DROI_PRO_FQ5CW_XDNZ)
#define QS_GLOVE_SWITCH 1
#else
#define QS_GLOVE_SWITCH 0
#endif
