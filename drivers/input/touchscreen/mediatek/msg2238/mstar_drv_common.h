 ...
 * By default, this compile option is disabled.
 */
#if defined(DROI_PRO_F5C_ZXHL) || defined(DROI_PRO_F5C_JF2) || defined(DROI_PRO_F6_ZR_M82)
 ...
 * By default, this compile option is disabled.
 */
#if defined(DROI_PRO_F5C62W_SGDZ_3)
...
#define CHIP_TYPE_MSG2836A	(0xbf) // EX. MSG2836A
...
//#define     TPD_DMESG(fmt, arg...)        printk(fmt, ##arg)
/*
#define DEBUG_LEVEL(level, dev, fmt, arg...) do {\
	                                           if (level <= TOUCH_DRIVER_DEBUG_LOG_LEVEL)\
