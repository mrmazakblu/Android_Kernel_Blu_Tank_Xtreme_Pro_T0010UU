...
typedef enum {
    ...
    MSG22XX_SW_ID_XXXX = 0x0001,	// dongdi
#else
    MSG22XX_SW_ID_XXXX = 0x0001,
#endif
#if defined(DROI_PRO_F6_ZR_M82)
	MSG22XX_SW_ID_YYYY = 0x0038,	// hongzhan
#else
...
typedef enum {
    ...
    MSG28XX_JF2_SW_ID_XXXX = 0x0337,
#endif
#ifdef DROI_PRO_PU6T_JF
    MSG2836A_SW_ID_XXXX = 0x0001,
#endif
    MSG28XX_SW_ID_XXXX = 0x0338,
