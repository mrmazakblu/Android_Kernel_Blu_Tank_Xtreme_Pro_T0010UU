 ...
 */
#define SF_DRV_VERSION "v1.3.1-20170817"
...
static const char *sf_pinctrl_state_names[SF_PIN_STATE_MAX] = {
    "power_on", "power_off", "fingerprint_reset_low", "fingerprint_reset_high", "fingerprint_pin_irq",
};
...
static int sf_ctl_init_input(void)
{
    ...
    __set_bit(KEY_F10, sf_ctl_dev.input->keybit);
...
static int __init sf_ctl_driver_init(void)
{
    ...
    int err = 0;
    xprintk(KERN_INFO, "--------dongm:init sf_ctl_driver_init--------");
